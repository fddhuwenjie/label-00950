      ...
      <div class="footer-content">
        ...
        <div class="footer-section">
          ...
          <ul>
            ...
            <li><router-link to="/help/returns">退换货政策</router-link></li>
            <li><router-link to="/help/shipping">配送说明</router-link></li>
            <li><router-link to="/help/payment">支付方式</router-link></li>
          </ul>
        </div>
        ...
        <div class="footer-section">
          <h3>购物指南</h3>
          <ul>
            <li><router-link to="/help/guide">新手指南</router-link></li>
            <li><router-link to="/help/duty">关税说明</router-link></li>
            <li><router-link to="/help/currency">货币转换</router-link></li>
            <li><router-link to="/help/size">尺码对照</router-link></li>
          </ul>
        </div>
